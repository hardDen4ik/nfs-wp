...
function get_response_file() {
	...
	$log_file_name= 'restore_response_' .$job_id. '.log';
...
function get_restore_Log() {
	...
	$status_file_name='restore_status_'.$job_id.'.log';
	$status_file_path = WPBACKITUP__PLUGIN_PATH .'/logs/'.$status_file_name;
...
function end_restore($err=null, $success=null){
	...
	$log_file_name='restore_status_' .$current_job->getJobId() .'.log';
	//error_log('end restore:'. $log_file_name);
